...
local km = require("hot.autokey")
local act = require("hot.actions.default")
local buf = require("utils.vim_buf")
local ze = require("hot.zellij")
local term = require("hot.actions.term")
...
km.set({ "n" }, "<leader>ww", require("hot.actions.write_file"), { desc = "Write file" })
km.set("n", "<M-m>", bind(ze.open, "<M-m>"), { desc = "Zellij Term" })
...
km.set("n", "<C-t>", term.copilot, { desc = "Copilot" })
...
km.set({ "n" }, "<M-p>", act.projects, { desc = "Change project cwd" })
